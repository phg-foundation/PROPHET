...
primary_data_final <- primary_data %>% 
  ...
  dplyr::select(covidence_id:ref, mendelian_randomization, AI, technology, clinical_utility, Rows, Columns, study_design_type, biomarker_name) %>%
  setNames(c("Covidence_ID", "Title", "Authors", "Abstract", "Published Year", "Journal", "Volume", "Issue", "Pages", "DOI", "Ref", 
             "Mendelian randomization", "Artificial intelligence", "Wearable technology", "Clinical utility", "Rows", "Columns",
             "Study design", "Biomarker examples"))
...
primary_data_final_bio <- primary_data %>% 
  ...
  mutate(across(where(is.character), str_trim)) %>%
  dplyr::select(covidence_id:ref, mendelian_randomization, AI, technology, clinical_utility, study_design_type, family_history, lifestyle, bio_subs,
                Rows, Columns, biomarkers, biomarker_name) %>%
  setNames(c("Covidence_ID", "Title", "Authors", "Abstract", "Published Year", "Journal", "Volume", "Issue", "Pages", "DOI", "Ref", 
             "Mendelian randomization", "Artificial intelligence", "Wearable technology", "Clinical utility", "Study design", "Family history", 
             "Lifestyle factors", "Biomarker subcategories", "Rows", "Columns", "Biomarker category", "Biomarker examples"))
...
secondary_data_final_bio <- secondary_data %>% 
  ...
  mutate(across(where(is.character), str_trim)) %>%
  dplyr::select(covidence_id:ref, mendelian_randomization, AI, technology, clinical_utility, study_design_type, family_history, bio_subs,
                Rows, Columns, biomarkers, biomarker_name) %>%
  setNames(c("Covidence_ID", "Title", "Authors", "Abstract", "Published Year", "Journal", "Volume", "Issue", "Pages", "DOI", "Ref", 
             "Mendelian randomization", "Artificial intelligence", "Wearable technology", "Clinical utility", "Study design", "Family history", 
             "Biomarker subcategories", "Rows", "Columns", "Biomarker category", "Biomarker examples"))
